...
//		product: null,
	...
	init: function(configValues){
		...
		jQuery('.fitment-selectors .fitment-save, .fitment-selectors .fitment-selectors-select').prop('disabled', true);
		jQuery('#fitment-make').value = '';
		jQuery('#fitment-year').value = '';
		jQuery('#fitment-model').value = '';
		jQuery('#fitment-make').change(this.changedMake.bind(this));
		jQuery('#fitment-year').change(this.changedYear.bind(this));
		jQuery('#fitment-model').change(this.changedModel.bind(this));
...
//				product: this.config.product,
	...
	changedModel: function(event){
		...
		if(event.target.value) {
			...
			jQuery('.fitment-selectors .fitment-save, .fitment-selectors .fitment-selectors-select').prop('disabled', false);
...
//		this.config.saved = Object.assign({}, this.config.fitment);
...
//		alert(response.message);
		...
		jQuery('.fitment-notice').addClass('fitment-compatible-yes');
...
//			this.config.fitment = Object.assign(this.config.fitment, this.config.saved);
