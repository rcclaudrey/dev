...
function createSidebar() {
	if(window.innerWidth < 600) {
		jQuery('#ariPartStream').css({width: "auto", float: "none"});
		jQuery('#ariInfoBack').css({width: "100%"});
		jQuery('#ariAssemblyList').css({width: "100%"});
		jQuery('#ariInfoZoom').css({left: "0 !important"});
		return;
	}
