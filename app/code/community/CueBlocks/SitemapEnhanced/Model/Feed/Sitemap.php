 ...
 * */
class CueBlocks_SitemapEnhanced_Model_Feed_Sitemap extends CueBlocks_SitemapEnhanced_Model_Feed_Abstract {

    const XML_FEED_URL = 'store.cueblocks.com/magento_notifications/';
    const XML_FEED_FILENAME = 'feed_sitemap.rss';
    const XML_LASTCHECK = 'cb_sitemap_notifications_lastcheck';
