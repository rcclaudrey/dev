 ...
 */
class Vikont_Pulliver_Model_Log
{
//    const LOG_FILE_NAME = 'pulliver.log';
    protected static $_logFileName = 'pulliver.log';
    const LOG_DIR = '/log';
    ...
    {
        return Mage::getStoreConfigFlag('evoc/general/keeplog');
    }
